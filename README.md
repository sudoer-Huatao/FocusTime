...
- Enable accessibility controls for this app.

**If this is not done, the app will NOT function properly**
...
```"FocusTime" can't be opened because Apple cannot check it for malicious software. This software needs to be updated. Contact the developer for more information.```

**You'll need to go to System Settings>Privacy and Security to manually allow the app to be opened.**
